...
export default function Testimonial() {
  const testimonial_cards = [
    ...
    },
    {
      name: "Ananya Sajjala",
      Testimony:
        " JAI HIND! Okaaay, so where should I even start, there is so much to say m about NSS but I doubt this feedback would be enough. NSS made e go out of my comfort zone- even before the projects, the recruitment process itself was so different from the others, we N ha S d S t n o o sing, dance, say dialogues, and whatnot. t only gave me an opportunity to contribute to society but also learn how to be confident and deal with people. And how can we forget Sojourn, it will always be one of my favourite memories of NSS. As for the projects, there are too many to go on about, so I’m going to talk about my favourite project which was the ashram visit- it was such a wonderful experience seeing all the elderly laugh and enjoy with us. And as for my NSS family, the sense of unity will always be unmatched, you guys were the best! I would say these two years in NSS were the best I could ask for, I will miss my NSS family for sure and as they say ONCE A VOLUNTEER ALWAYS A VOLUNTEER",
      image: `${Images.female}`,
      year: "2023-25",
      branch: "Comp",
      post: "Volunteer",
          ...
          <div key={index} className="Testimonail-card">
            <div id="creator">
              ...
              <div className="details">
                ...
                <p>
                  {testimonial.year} {testimonial.branch}
                </p>
              </div>
            </div>
            ...
            <div id="testimony">
              <p>
                {testimonial.Testimony.substring(0, 200)}{" "}
                <span
                  style={{
